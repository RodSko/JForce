...
const BASES_AL = ['ARP-AL', 'F ARP - AL', 'F ARP 02-AL', 'PMI-AL', 'STI-AL', 'CAL-AL', 'CRP-AL', 'MDC-AL', 'JCN-AL', 'JGA-AL', 'F MCZ-AL', 'F MCZ 02-AL', 'F MRG - AL', 'F PND - AL', 'F CAL - AL', 'F JAT - AL', 'F UNP - AL'];
